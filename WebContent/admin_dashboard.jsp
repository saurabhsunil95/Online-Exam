...
<form action="Logout">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-12 box">
            <center><h2 class="mb-12">Select</h2></center>
    ...
    if(null!=request.getAttribute("subjectAdd"))
    {
        out.println(request.getAttribute("subjectAdd"));
    }
%></div>
<center><div style="color:green"><%
    if(null!=request.getAttribute("questionAdd"))
    {
        out.println(request.getAttribute("questionAdd"));
    }
%></div><br>
				  
				  <div class="w3-container">
 						<h3>Add subject  </h3>
  						<a href="add_subject.jsp" ><button class="w3-button w3-xlarge w3-circle w3-teal">+</button></a><br>
  						<h3>Add question  </h3>
 						<a href="add_questions.jsp"><button class="w3-button w3-xlarge w3-circle w3-teal">+</button></a>
				</div>
