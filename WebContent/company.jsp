        ...
        <div class="row justify-content-center">
          <div class="col-md-5 box">
            ...
            <form action="CompanyLogin">
                  <div class="row">
                  <div style="color:red"><%
    if(null!=request.getAttribute("errorMessageAdmin"))
    {
        out.println(request.getAttribute("errorMessageAdmin"));
    }
%></div>
                    <div class="col-md-12 form-group">
                      <label for="name">Company UserId</label>
                      <input type="text" id="name" name="user" class="form-control " required="true">
                    </div>
                  </div>
                  <div class="row mb-5">
                    <div class="col-md-12 form-group">
                      <label for="name">Password</label>
                      <input type="password" id="name" name="password" class="form-control " required="true">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                      ...
                      <br><a href='forgot.jsp'>Forgot Password</a>
                      <br>
                      <br>
                      <ul><li><a href="admin.jsp">Admin Login</a></li>
                        <li><a href="company.jsp">Students Login</a></li></ul>
                    </div>
                  </div>
                </form>
          </div>
