...
%></div>
                    <div class="col-md-12 form-group">
                      ...
                      <input type="email" id="name" name="mail" class="form-control " required="true">
                    </div>
                  </div>
                  <!--<div class="row mb-5">
                    <div class="col-md-12 form-group">
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                      ...
                      <br>
                      <br>
                      <ul><li><a href="login.jsp">Students Login</a></li>
                        <li><a href="company.jsp">Company Login</a></li></ul>
                    </div>
                  </div>
                </form>
          </div>
